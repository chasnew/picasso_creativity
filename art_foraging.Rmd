...
summary_df %>% 
  ...
  geom_errorbarh(aes(xmin = step_size - step_se,
                 ...
                 height = 0.0025) +
  scale_x_continuous("Daily step size") +
  scale_y_continuous("Daily turn angle") +
...
ggplot(combined_results, aes(x = interval, y = cos_avg, color = source)) +
  geom_point() +
  scale_color_manual(values = cbPalette) +
  theme_minimal()

ggsave(file.path("img", "picasso_vs_null_interval_cossim.png"))
```
