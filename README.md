...
File "art_foraging.Rmd" contains data processing and sliding window analyses for Picasso's stylistic movements over his career. Similarly, files "bob_ross_analysis.Rmd", "cezanne_analysis.Rmd", and "monet_analysis.Rmd" contain the same analysis pipeline for Bob Ross, Cézanne, and Monet.\
