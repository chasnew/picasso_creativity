...
# artwork images
sample_dir <- c("Blue", "Cubism", "Neoclassicism")
sample_images <- list.files(file.path("sample_images", sample_dir[1]))
sample_path <- file.path("sample_images", sample_dir[1], sample_images[1])
